            ...
            <div className="flex gap-4 items-center">
                ...
                <div>
                    <div className="text-lg flex gap-4 items-baseline">
                        ...
                        {isDiscounted && <div className="text-lg">{formatCurrency(amount / 100)}</div>}
                    </div>
...
const Form = ({ priceInCents, productId, discountCode }: { priceInCents: number, productId: string, discountCode?: { id: string, discountAmount: number, discountType: DiscountCodeType } }) => {
